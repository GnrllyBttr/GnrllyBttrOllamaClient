...
void main() {
  group('Given an GnrllyBttrOllamaClient instance', () {
    ...
    group('When calling chat', () {
      test(
        'Then it should send a POST request and return ChatResponse',
        () async {
      ...
      test(
        'Then it should throw ChatFailedException when the request fails',
        () {
          final request = ChatRequest(
            model: faker.lorem.word(),
            messages: <ChatMessage>[],
    ...
    group('When calling chatStream', () {
      test('Then it should return a Stream of ChatResponse', () async {
        ...
        when(
          ...
          (_) => Stream.fromIterable(<String>[jsonEncode(response.toJson())]),
        );
    ...
    group('When calling createModel', () {
      test(
        'Then it should send a POST request and return CreateStatus',
        () async {
          final request = CreateModelRequest(
            model: faker.lorem.word(),
            from: faker.lorem.word(),
            files: <String, String>{faker.lorem.word(): faker.guid.guid()},
            adapters: <String, String>{faker.lorem.word(): faker.guid.guid()},
          ...
          when(
            ...
            (_) async => HttpResponse(data: response.toJson(), statusCode: 200),
          );
    ...
    group('When calling createModelStream', () {
      test('Then it should return a Stream of CreateStatus', () async {
        ...
        final result = gnrllyBttrOllamaClient.createModelStream(
          request: request,
        );
    ...
    group('When calling embeddings', () {
      test(
        'Then it should send a POST request and return EmbedResponse',
        () async {
          ...
          final result = await gnrllyBttrOllamaClient.embeddings(
            request: request,
          );
    ...
    group('When calling generate', () {
      test(
        'Then it should send a POST request and return GenerateResponse',
        () async {
          ...
          final result = await gnrllyBttrOllamaClient.generate(
            request: request,
          );
    ...
    group('When calling getVersion', () {
      test(
        'Then it should send a GET request and return VersionResponse',
        () async {
          final response = VersionResponse(version: faker.guid.guid());
    ...
    group('When calling listRunningModels', () {
      test(
        'Then it should send a GET request and return ModelStatusList',
        () async {
    ...
    group('When calling pullModel', () {
      test(
        'Then it should send a POST request and return PullStatus',
        () async {
          ...
          final result = await gnrllyBttrOllamaClient.pullModel(
            request: request,
          );
    ...
    group('When calling pushBlob', () {
      test('Then it should send a POST request to push the blob', () async {
        ...
        final data = List<int>.generate(
          10,
          (_) => faker.randomGenerator.integer(256),
        );
    ...
    group('When calling pushModel', () {
      test(
        'Then it should send a POST request and return PushStatus',
        () async {
          ...
          final result = await gnrllyBttrOllamaClient.pushModel(
            request: request,
          );
    ...
    group('When calling showModel', () {
      ...
      test(
        ...
        () {
          ...
          expect(
            () => gnrllyBttrOllamaClient.showModeInformation(
              modelName: modelName,
            ),
