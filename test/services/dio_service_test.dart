...
void main() {
  ...
  group('Given a DioService instance', () {
    group('When sending a GET request', () {
      test(
        ...
        () async {
          ...
          final expectedResponse = _generateFakeHttpResponse({
            'result': 'w6S1q',
          });
    ...
    group('When sending a POST request', () {
      test(
        ...
        () async {
          ...
          final fakeDioResponse = _generateFakeDioResponse({
            'result': 'q[\\4_|`',
          });
          final expectedResponse = _generateFakeHttpResponse({
            'result': 'q[\\4_|`',
    ...
    group('When adding interceptors', () {
      ...
      test(
        'addResponseInterceptor should add a response interceptor',
        () async {
